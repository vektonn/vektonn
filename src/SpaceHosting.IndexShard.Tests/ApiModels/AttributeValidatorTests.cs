...
using static SpaceHosting.IndexShard.Tests.ApiModels.AttributeDtoTestHelpers;
...
namespace SpaceHosting.IndexShard.Tests.ApiModels
{
    public class AttributeValidatorTests
    {
        ...
        private static IEnumerable<TestCaseData> TestCases()
        {
            ...
            yield return new TestCaseData(
                new AttributeDto("k1", new AttributeValue(String: null, Guid: null, Bool: null, Int64: null, DateTime: null)),
                KnownAttributes(("k1", AttributeValueTypeCode.String))
            ) {ExpectedResult = "Test attribute 'k1' has invalid value: ''"};

            yield return new TestCaseData(
                new AttributeDto("k1", new AttributeValue(String: "str", Int64: 42)),
                KnownAttributes(("k1", AttributeValueTypeCode.String))
